...
## Datapack:
  ...
  - `winter-full` includes all snowy biomes, but is likely to have versioning issues

> [!NOTE]
> `winter-full` is broken above 1.21.11 due to the size of the generator, pull requests are welcome
